...
namespace GradingTests
{
    ...
    public class SpreadsheetTest
    {
        ...
        [TestMethod()]
        [ExpectedException(typeof(InvalidNameException))]
        public void GradingTest5()
        {
            Spreadsheet s = new Spreadsheet();
            PrivateObject ss_accessor = new PrivateObject(s);
            ss_accessor.Invoke("SetCellContents", new object[] { "1A1A", 1.5 });
        }

        [TestMethod()]
        public void GradingTest6()
        {
            Spreadsheet s = new Spreadsheet();
            PrivateObject ss_accessor = new PrivateObject(s);
            ss_accessor.Invoke("SetCellContents", new object[] { "Z7", 1.5 });
            Assert.AreEqual(1.5, (double)s.GetCellContents("Z7"), 1e-9);
        }

        [TestMethod()]
        [ExpectedException(typeof(InvalidNameException))]
        public void GradingTest8()
        {
            Spreadsheet s = new Spreadsheet();
            PrivateObject ss_accessor = new PrivateObject(s);
            ss_accessor.Invoke("SetCellContents", new object[] { null, "hello" });
        }

        [TestMethod()]
        [ExpectedException(typeof(InvalidNameException))]
        public void GradingTest9()
        {
            Spreadsheet s = new Spreadsheet();
            PrivateObject ss_accessor = new PrivateObject(s);
            ss_accessor.Invoke("SetCellContents", new object[] { "1AZ", "hello" });
        }

        [TestMethod()]
        public void GradingTest10()
        {
            Spreadsheet s = new Spreadsheet();
            PrivateObject ss_accessor = new PrivateObject(s);
            ss_accessor.Invoke("SetCellContents", new object[] { "Z7", "hello" });
        ...
        [TestMethod()]
        [ExpectedException(typeof(InvalidNameException))]
        public void GradingTest12()
        {
            Spreadsheet s = new Spreadsheet();
            PrivateObject ss_accessor = new PrivateObject(s);
            ss_accessor.Invoke("SetCellContents", new object[] { null, new Formula("2") });
        }
        ...
        public void GradingTest13()
        {
            Spreadsheet s = new Spreadsheet();
            PrivateObject ss_accessor = new PrivateObject(s);
            ss_accessor.Invoke("SetCellContents", new object[] { "1AZ", new Formula("2") });
        }

        [TestMethod()]
        public void GradingTest14()
        {
            Spreadsheet s = new Spreadsheet();
            PrivateObject ss_accessor = new PrivateObject(s);
            ss_accessor.Invoke("SetCellContents", new object[] { "Z7", new Formula("3") });
        ...
        public void GradingTest15()
        {
            Spreadsheet s = new Spreadsheet();
            PrivateObject ss_accessor = new PrivateObject(s);
            ss_accessor.Invoke("SetCellContents", new object[] { "A1", new Formula("A2") });
            ss_accessor.Invoke("SetCellContents", new object[] { "A2", new Formula("A1") });
        }

        [TestMethod()]
        [ExpectedException(typeof(CircularException))]
        public void GradingTest16()
        {
            Spreadsheet s = new Spreadsheet();
        ...
        [TestMethod()]
        public void GradingTest47()
        {
            RunRandomizedTest(47, 2519);
        }
        [TestMethod()]
        public void GradingTest48()
        {
            RunRandomizedTest(48, 2521);
        }
        [TestMethod()]
        public void GradingTest49()
        {
            RunRandomizedTest(49, 2526);
        }
        [TestMethod()]
        public void GradingTest50()
        {
